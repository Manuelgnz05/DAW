...
public class clase4 {
       ...
       /*
         ...
         */
            ...
            System.out.println("El decimal leido es " + decimal);


            System.out.print("Introduce un double: ");
            double valor2 = scan.nextDouble();
            System.out.println("El double leido es " + valor2);

            System.out.print("Introduce un boolean: ");
            boolean valor3 = scan.nextBoolean();
            System.out.println("El boolean leido es " + valor3);

            System.out.print("Introduce un string: ");
            String valor4 = scan.next();
            System.out.println("El string leido es " + valor4);
